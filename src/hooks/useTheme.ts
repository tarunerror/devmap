...
export type ThemeMode = "fusion" | "terminal" | "zen" | "quest" | "modern" | "retro";
...
export const themeConfigs: Record<ThemeMode, ThemeConfig> = {
  fusion: {
    name: "fusion",
    displayName: "Fusion",
    description: "Intelligent blend of all themes",
    icon: "🌀",
    fonts: {
...
export const getThemeClasses = (theme: ThemeMode) => {
  const classes: Record<ThemeMode, Record<string, string>> = {
    fusion: {
      ...
      badge: "bg-gradient-to-r from-emerald-100 to-green-100 dark:from-emerald-900/30 dark:to-green-900/30",
    },
    terminal: {
      card: "bg-black/90 border border-green-500/30 rounded-lg font-mono",
      button: "bg-green-500/20 border border-green-500 text-green-400 hover:bg-green-500/30",
    ...
    zen: {
      ...
      button: "bg-stone-200 dark:bg-stone-700 hover:bg-stone-300 dark:hover:bg-stone-600 text-stone-800 dark:text-stone-200",
    ...
    quest: {
      ...
      button: "bg-gradient-to-r from-violet-500 to-purple-600 hover:from-violet-600 hover:to-purple-700 shadow-lg shadow-violet-500/30",
      heading: "font-bold text-violet-900 dark:text-violet-100",
      text: "text-violet-700 dark:text-violet-300",
      border: "border-violet-300 dark:border-violet-600",
      badge: "bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/30 dark:to-amber-900/30 border border-yellow-300 dark:border-yellow-700",
    },
    modern: {
    ...
    retro: {
      ...
      button: "bg-pink-500 hover:bg-pink-400 text-white border-b-4 border-pink-700 active:border-b-0 active:mt-1",
